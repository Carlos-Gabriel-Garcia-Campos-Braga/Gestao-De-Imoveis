namespace GestaoImoveisAPI.Domain.Leasing.Repositories
{
    public interface IRentalContractRepository
    {
        ...
        Task<IReadOnlyList<RentalContract>> GetArchivedWithDetailsAsync(CancellationToken ct = default);
        Task<RentalContract?> GetArchivedByIdAsync(int id, CancellationToken ct = default);
